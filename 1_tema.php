        ...
        <div class="">
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div id="contenido">
        <br><br><br>
        <?php  $query = "SELECT tema FROM tema WHERE id = ".$tema ;
         $resultado = $conn->query($query);
         $fila = $resultado->fetch_assoc();
         
        ?>
        <h1 class=""> <?php echo $fila["tema"]; ?> </h1>
        <br><br>
...
<?php
 ...
 //$query = "SELECT * FROM cursos";
       $query = " SELECT c.id, c.titulo,c.descripcion,c.imagen_url,c.url, p.plataforma,u.universidad,t.tema FROM cursos c , plataforma p, universidad u, tema t WHERE c.id_plataforma=p.id AND c.id_tema = t.id AND c.id_universidad = u.id AND t.id = ".$tema;
        // echo $query;
        $resultado = $conn->query($query);
